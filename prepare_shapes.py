...
generate_gaussian_pyramid4("./shapes/gaussian_pyramid_larger_wider.obj",
                               size=19,       #increased the base size (e.g., from 10 to 20)
                                resolution=0.5, #keep resolution the same 
                                sigma=5.7,       #increased sigma to make it wider/less steep
                                height=7,     #height increased
                                noise_scale=0.5,
                                noise_factor=1.0
)
